const reasons = [
  {
    ...
    description:
      "Profissionais experientes e dedicados, garantindo sempre um resultado de excelência para cada cliente.",
  },
  {
    number: "02",
    title: "Qualidade Superior",
    description:
      "Utilizamos os melhores produtos e técnicas do mercado para que o resultado supere sempre as expectativas.",
  },
  {
    number: "03",
    title: "Experiência Premium",
    description:
      "Um espaço cuidado e acolhedor onde cada detalhe foi pensado para proporcionar o máximo conforto.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-px bg-brand-gold/10">
          {reasons.map((r) => (
            <div
              key={r.number}
              className="bg-brand-green p-10 hover:bg-brand-green-mid transition-colors group"
            >
              <p className="text-brand-gold/25 font-black text-5xl mb-8 group-hover:text-brand-gold/40 transition-colors">
                {r.number}
              </p>
              <h3 className="text-brand-gold font-bold text-lg tracking-wide mb-3">
                {r.title}
              </h3>
        ...
        <div className="mt-px bg-brand-dark px-10 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            Venha descobrir a diferença no seu negócio.
          </p>
          <a
            href="#servicos"
